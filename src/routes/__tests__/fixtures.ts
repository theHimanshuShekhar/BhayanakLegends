...
export const champSelectSession: ChampSelectSnapshot = {
  ...
  ally: [
    { cell_id: 0, champion_id: 22, champion: "Lucian", name: "FixturePlayer09", is_local: false, state: "picked" },
    { cell_id: 1, champion_id: 121, champion: null, name: "FixturePlayer07", is_local: false, state: "intent" },
    { cell_id: 2, champion_id: 498, champion: "Xayah", name: "FixturePlayer24", is_local: true, state: "picked" },
    { cell_id: 3, champion_id: 0, champion: null, name: null, is_local: false, state: "none" },
    { cell_id: 4, champion_id: 34, champion: "Amumu", name: "FixturePlayer08", is_local: false, state: "intent" },
  ],
  enemy: [
...
export const ingameSnapshot: InGameSnapshot = {
  ...
  clock_s: 1254,
  mode: "CLASSIC",
  local_summoner: "FixturePlayer24",
  local_champion: "Viktor",
  teams: {
    order: [
      { summoner: "FixturePlayer09", champion: "Ornn", level: 11, kills: 2, deaths: 3, assists: 4, cs: 178, ward_score: 0.8, items: [] },
      { summoner: "FixturePlayer07", champion: "Vi", level: 12, kills: 3, deaths: 2, assists: 6, cs: 141, ward_score: 1.1, items: [] },
      { summoner: "FixturePlayer24", champion: "Viktor", level: 12, kills: 4, deaths: 2, assists: 7, cs: 213, ward_score: 1.42, items: [] },
      { summoner: "FixturePlayer06", champion: "Xayah", level: 12, kills: 5, deaths: 1, assists: 3, cs: 236, ward_score: 0.4, items: [] },
      { summoner: "FixturePlayer08", champion: "Leona", level: 10, kills: 1, deaths: 4, assists: 12, cs: 32, ward_score: 2.6, items: [] },
    ],
    chaos: [
      { summoner: "FixturePlayer14", champion: "Camille", level: 12, kills: 3, deaths: 2, assists: 2, cs: 195, ward_score: 0.5, items: [] },
      { summoner: "FixturePlayer11", champion: "Lee Sin", level: 11, kills: 2, deaths: 3, assists: 4, cs: 128, ward_score: 0.9, items: [] },
      { summoner: "FixturePlayer12", champion: "Ahri", level: 11, kills: 2, deaths: 4, assists: 3, cs: 187, ward_score: 0.7, items: [] },
      { summoner: "FixturePlayer10", champion: "Ashe", level: 11, kills: 1, deaths: 5, assists: 2, cs: 201, ward_score: 0.3, items: [] },
      { summoner: "FixturePlayer13", champion: "Thresh", level: 10, kills: 0, deaths: 4, assists: 8, cs: 28, ward_score: 2.1, items: [] },
    ],
  },
  events: [
    ...
    { name: "ChampionKill", t_s: 700.14, actor: "FixturePlayer24", victim: "FixturePlayer10", detail: null },
